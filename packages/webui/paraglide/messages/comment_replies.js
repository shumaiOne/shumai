...
*/
export const comment_replies = /** @type {((inputs?: Comment_RepliesInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Comment_RepliesInputs, { locale?: "en" | "zh" }, {}>} */ ((inputs = {}, options = {}) => {
