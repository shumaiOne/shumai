...
*/
export const edit_item = /** @type {((inputs: Edit_ItemInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Edit_ItemInputs, { locale?: "en" | "zh" }, {}>} */ ((inputs, options = {}) => {
