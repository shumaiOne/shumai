...
const en_all_share_links_count =
  /** @type {(inputs: All_Share_Links_CountInputs) => LocalizedString} */ (i) => {
    return /** @type {LocalizedString} */ (`All Share Links (${i?.count})`)
  }

const zh_all_share_links_count =
  /** @type {(inputs: All_Share_Links_CountInputs) => LocalizedString} */ (i) => {
...
export const all_share_links_count =
  /** @type {((inputs: All_Share_Links_CountInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<All_Share_Links_CountInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs, options = {}) => {
