...
*/
export const filter = /** @type {((inputs?: FilterInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<FilterInputs, { locale?: "en" | "zh" }, {}>} */ ((inputs = {}, options = {}) => {
