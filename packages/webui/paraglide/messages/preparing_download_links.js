...
const en_preparing_download_links =
  /** @type {(inputs: Preparing_Download_LinksInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Preparing download links...`)
  }

const zh_preparing_download_links =
  /** @type {(inputs: Preparing_Download_LinksInputs) => LocalizedString} */ () => {
...
export const preparing_download_links =
  /** @type {((inputs?: Preparing_Download_LinksInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Preparing_Download_LinksInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
