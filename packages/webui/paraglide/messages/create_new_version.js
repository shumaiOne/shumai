...
const en_create_new_version =
  /** @type {(inputs: Create_New_VersionInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Create new version`)
  }

const zh_create_new_version =
  /** @type {(inputs: Create_New_VersionInputs) => LocalizedString} */ () => {
...
export const create_new_version =
  /** @type {((inputs?: Create_New_VersionInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Create_New_VersionInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
