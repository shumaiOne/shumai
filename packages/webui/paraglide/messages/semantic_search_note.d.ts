...
*/
export const semantic_search_note: ((inputs?: Semantic_Search_NoteInputs, options?: {
    locale?: "en" | "zh";
}) => LocalizedString) & import("../runtime.js").MessageMetadata<Semantic_Search_NoteInputs, {
    locale?: "en" | "zh";
}, {}>;
