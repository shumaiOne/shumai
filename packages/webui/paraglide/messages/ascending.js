...
*/
export const ascending = /** @type {((inputs?: AscendingInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<AscendingInputs, { locale?: "en" | "zh" }, {}>} */ ((inputs = {}, options = {}) => {
