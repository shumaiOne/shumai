 ...
 */
export const agent_type_chat =
  /** @type {((inputs?: Agent_Type_ChatInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Agent_Type_ChatInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
