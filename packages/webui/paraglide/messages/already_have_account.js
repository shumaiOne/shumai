...
const en_already_have_account =
  /** @type {(inputs: Already_Have_AccountInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Already have an account? `)
  }

const zh_already_have_account =
  /** @type {(inputs: Already_Have_AccountInputs) => LocalizedString} */ () => {
...
export const already_have_account =
  /** @type {((inputs?: Already_Have_AccountInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Already_Have_AccountInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
