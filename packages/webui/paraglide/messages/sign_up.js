...
*/
export const sign_up = /** @type {((inputs?: Sign_UpInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Sign_UpInputs, { locale?: "en" | "zh" }, {}>} */ ((inputs = {}, options = {}) => {
