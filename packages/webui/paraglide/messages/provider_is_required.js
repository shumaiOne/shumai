...
const en_provider_is_required =
  /** @type {(inputs: Provider_Is_RequiredInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Provider is required`)
  }

const zh_provider_is_required =
  /** @type {(inputs: Provider_Is_RequiredInputs) => LocalizedString} */ () => {
...
export const provider_is_required =
  /** @type {((inputs?: Provider_Is_RequiredInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Provider_Is_RequiredInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
