...
*/
export const sort_z_to_a = /** @type {((inputs?: Sort_Z_To_AInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Sort_Z_To_AInputs, { locale?: "en" | "zh" }, {}>} */ ((inputs = {}, options = {}) => {
