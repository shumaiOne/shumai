...
const en_upload_cover_hint =
  /** @type {(inputs: Upload_Cover_HintInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Drag and drop, or browse. Recommended 1:1 (400×400px).`)
  }

const zh_upload_cover_hint =
  /** @type {(inputs: Upload_Cover_HintInputs) => LocalizedString} */ () => {
 ...
 */
export const upload_cover_hint =
  /** @type {((inputs?: Upload_Cover_HintInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Upload_Cover_HintInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
