...
const en_preview_unavailable =
  /** @type {(inputs: Preview_UnavailableInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Preview unavailable`)
  }

const zh_preview_unavailable =
  /** @type {(inputs: Preview_UnavailableInputs) => LocalizedString} */ () => {
...
export const preview_unavailable =
  /** @type {((inputs?: Preview_UnavailableInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Preview_UnavailableInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
