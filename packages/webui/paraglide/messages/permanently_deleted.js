...
const en_permanently_deleted =
  /** @type {(inputs: Permanently_DeletedInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Permanently deleted`)
  }

const zh_permanently_deleted =
  /** @type {(inputs: Permanently_DeletedInputs) => LocalizedString} */ () => {
...
export const permanently_deleted =
  /** @type {((inputs?: Permanently_DeletedInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Permanently_DeletedInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
