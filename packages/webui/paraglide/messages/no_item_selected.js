...
const en_no_item_selected =
  /** @type {(inputs: No_Item_SelectedInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`No item selected`)
  }

const zh_no_item_selected =
  /** @type {(inputs: No_Item_SelectedInputs) => LocalizedString} */ () => {
...
export const no_item_selected =
  /** @type {((inputs?: No_Item_SelectedInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<No_Item_SelectedInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
