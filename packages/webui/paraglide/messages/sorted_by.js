...
*/
export const sorted_by = /** @type {((inputs: Sorted_ByInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Sorted_ByInputs, { locale?: "en" | "zh" }, {}>} */ ((inputs, options = {}) => {
