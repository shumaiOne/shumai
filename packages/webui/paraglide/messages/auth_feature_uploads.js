...
const en_auth_feature_uploads =
  /** @type {(inputs: Auth_Feature_UploadsInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Instant asset uploads & high-fidelity media players`)
  }

const zh_auth_feature_uploads =
  /** @type {(inputs: Auth_Feature_UploadsInputs) => LocalizedString} */ () => {
...
export const auth_feature_uploads =
  /** @type {((inputs?: Auth_Feature_UploadsInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Auth_Feature_UploadsInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
