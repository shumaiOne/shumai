...
const en_auth_feature_metadata =
  /** @type {(inputs: Auth_Feature_MetadataInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Custom metadata schemas & drawing canvas reviews`)
  }

const zh_auth_feature_metadata =
  /** @type {(inputs: Auth_Feature_MetadataInputs) => LocalizedString} */ () => {
...
export const auth_feature_metadata =
  /** @type {((inputs?: Auth_Feature_MetadataInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Auth_Feature_MetadataInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
