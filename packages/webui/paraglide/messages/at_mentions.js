...
*/
export const at_mentions = /** @type {((inputs?: At_MentionsInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<At_MentionsInputs, { locale?: "en" | "zh" }, {}>} */ ((inputs = {}, options = {}) => {
