...
const en_no_account_prompt =
  /** @type {(inputs: No_Account_PromptInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Don't have an account? `)
  }

const zh_no_account_prompt =
  /** @type {(inputs: No_Account_PromptInputs) => LocalizedString} */ () => {
...
export const no_account_prompt =
  /** @type {((inputs?: No_Account_PromptInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<No_Account_PromptInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
