...
*/
export const back = /** @type {((inputs?: BackInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<BackInputs, { locale?: "en" | "zh" }, {}>} */ ((inputs = {}, options = {}) => {
