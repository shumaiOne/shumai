...
*/
export const failed_to_move = /** @type {((inputs?: Failed_To_MoveInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Failed_To_MoveInputs, { locale?: "en" | "zh" }, {}>} */ ((inputs = {}, options = {}) => {
