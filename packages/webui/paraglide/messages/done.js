...
*/
export const done = /** @type {((inputs?: DoneInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<DoneInputs, { locale?: "en" | "zh" }, {}>} */ ((inputs = {}, options = {}) => {
