...
const en_date_one_week_from_now =
  /** @type {(inputs: Date_One_Week_From_NowInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`One week from now`)
  }

const zh_date_one_week_from_now =
  /** @type {(inputs: Date_One_Week_From_NowInputs) => LocalizedString} */ () => {
...
export const date_one_week_from_now =
  /** @type {((inputs?: Date_One_Week_From_NowInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Date_One_Week_From_NowInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
