...
const en_invalid_email_address =
  /** @type {(inputs: Invalid_Email_AddressInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Invalid email address`)
  }

const zh_invalid_email_address =
  /** @type {(inputs: Invalid_Email_AddressInputs) => LocalizedString} */ () => {
...
export const invalid_email_address =
  /** @type {((inputs?: Invalid_Email_AddressInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Invalid_Email_AddressInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
