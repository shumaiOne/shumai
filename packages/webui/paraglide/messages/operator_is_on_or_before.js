...
const en_operator_is_on_or_before =
  /** @type {(inputs: Operator_Is_On_Or_BeforeInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`is on or before`)
  }

const zh_operator_is_on_or_before =
  /** @type {(inputs: Operator_Is_On_Or_BeforeInputs) => LocalizedString} */ () => {
...
export const operator_is_on_or_before =
  /** @type {((inputs?: Operator_Is_On_Or_BeforeInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Operator_Is_On_Or_BeforeInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
