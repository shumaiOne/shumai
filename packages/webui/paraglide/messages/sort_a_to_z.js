...
*/
export const sort_a_to_z = /** @type {((inputs?: Sort_A_To_ZInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Sort_A_To_ZInputs, { locale?: "en" | "zh" }, {}>} */ ((inputs = {}, options = {}) => {
