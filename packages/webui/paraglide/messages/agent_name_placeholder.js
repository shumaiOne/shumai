...
const en_agent_name_placeholder =
  /** @type {(inputs: Agent_Name_PlaceholderInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`e.g., Support Assistant`)
  }

const zh_agent_name_placeholder =
  /** @type {(inputs: Agent_Name_PlaceholderInputs) => LocalizedString} */ () => {
...
export const agent_name_placeholder =
  /** @type {((inputs?: Agent_Name_PlaceholderInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Agent_Name_PlaceholderInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
