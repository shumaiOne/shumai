...
const en_failed_to_update_member_role =
  /** @type {(inputs: Failed_To_Update_Member_RoleInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Failed to update member role`)
  }

const zh_failed_to_update_member_role =
  /** @type {(inputs: Failed_To_Update_Member_RoleInputs) => LocalizedString} */ () => {
...
export const failed_to_update_member_role =
  /** @type {((inputs?: Failed_To_Update_Member_RoleInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Failed_To_Update_Member_RoleInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
