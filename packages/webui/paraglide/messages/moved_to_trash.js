...
*/
export const moved_to_trash = /** @type {((inputs?: Moved_To_TrashInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Moved_To_TrashInputs, { locale?: "en" | "zh" }, {}>} */ ((inputs = {}, options = {}) => {
