...
const en_show_right_sidebar =
  /** @type {(inputs: Show_Right_SidebarInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Show Right Sidebar`)
  }

const zh_show_right_sidebar =
  /** @type {(inputs: Show_Right_SidebarInputs) => LocalizedString} */ () => {
...
export const show_right_sidebar =
  /** @type {((inputs?: Show_Right_SidebarInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Show_Right_SidebarInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
