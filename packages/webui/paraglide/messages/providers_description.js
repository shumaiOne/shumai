...
const en_providers_description =
  /** @type {(inputs: Providers_DescriptionInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Configure AI providers and their models for this team.`)
  }

const zh_providers_description =
  /** @type {(inputs: Providers_DescriptionInputs) => LocalizedString} */ () => {
...
export const providers_description =
  /** @type {((inputs?: Providers_DescriptionInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Providers_DescriptionInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
