...
const en_network_sandbox_description =
  /** @type {(inputs: Network_Sandbox_DescriptionInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (
      `Configure allowed domains for the sandboxed agent. By default, only essential domains are allowed.`
    )
  }

const zh_network_sandbox_description =
  /** @type {(inputs: Network_Sandbox_DescriptionInputs) => LocalizedString} */ () => {
 ...
 */
export const network_sandbox_description =
  /** @type {((inputs?: Network_Sandbox_DescriptionInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Network_Sandbox_DescriptionInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
