...
const en_email_managed_by_auth =
  /** @type {(inputs: Email_Managed_By_AuthInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Email address is managed by authentication provider.`)
  }

const zh_email_managed_by_auth =
  /** @type {(inputs: Email_Managed_By_AuthInputs) => LocalizedString} */ () => {
...
export const email_managed_by_auth =
  /** @type {((inputs?: Email_Managed_By_AuthInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Email_Managed_By_AuthInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
