...
const en_collection_renamed =
  /** @type {(inputs: Collection_RenamedInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Collection renamed`)
  }

const zh_collection_renamed =
  /** @type {(inputs: Collection_RenamedInputs) => LocalizedString} */ () => {
...
export const collection_renamed =
  /** @type {((inputs?: Collection_RenamedInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Collection_RenamedInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
