...
*/
export const quota_resource_agent_bash_call_count = /** @type {((inputs?: Quota_Resource_Agent_Bash_Call_CountInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Quota_Resource_Agent_Bash_Call_CountInputs, { locale?: "en" | "zh" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "en") return en_quota_resource_agent_bash_call_count(inputs)
	return zh_quota_resource_agent_bash_call_count(inputs)
});