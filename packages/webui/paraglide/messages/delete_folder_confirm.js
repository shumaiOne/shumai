...
const en_delete_folder_confirm =
  /** @type {(inputs: Delete_Folder_ConfirmInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Delete Folder?`)
  }

const zh_delete_folder_confirm =
  /** @type {(inputs: Delete_Folder_ConfirmInputs) => LocalizedString} */ () => {
...
export const delete_folder_confirm =
  /** @type {((inputs?: Delete_Folder_ConfirmInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Delete_Folder_ConfirmInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
