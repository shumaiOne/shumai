...
*/
export const all_resolutions = /** @type {((inputs?: All_ResolutionsInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<All_ResolutionsInputs, { locale?: "en" | "zh" }, {}>} */ ((inputs = {}, options = {}) => {
