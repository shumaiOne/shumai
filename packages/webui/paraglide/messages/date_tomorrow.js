...
*/
export const date_tomorrow = /** @type {((inputs?: Date_TomorrowInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Date_TomorrowInputs, { locale?: "en" | "zh" }, {}>} */ ((inputs = {}, options = {}) => {
