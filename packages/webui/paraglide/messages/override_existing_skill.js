...
const en_override_existing_skill =
  /** @type {(inputs: Override_Existing_SkillInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Do you want to override the existing skill?`)
  }

const zh_override_existing_skill =
  /** @type {(inputs: Override_Existing_SkillInputs) => LocalizedString} */ () => {
 ...
 */
export const override_existing_skill =
  /** @type {((inputs?: Override_Existing_SkillInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Override_Existing_SkillInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
