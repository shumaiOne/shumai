...
const en_no_agents_found = /** @type {(inputs: No_Agents_FoundInputs) => LocalizedString} */ (
  i,
) => {
  return /** @type {LocalizedString} */ (`No ${i?.type} agents found`)
}

const zh_no_agents_found = /** @type {(inputs: No_Agents_FoundInputs) => LocalizedString} */ (
  i,
) => {
...
export const no_agents_found =
  /** @type {((inputs: No_Agents_FoundInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<No_Agents_FoundInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs, options = {}) => {
