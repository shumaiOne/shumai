...
*/
export const shares = /** @type {((inputs?: SharesInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<SharesInputs, { locale?: "en" | "zh" }, {}>} */ ((inputs = {}, options = {}) => {
