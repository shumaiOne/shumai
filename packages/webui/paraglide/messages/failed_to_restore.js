...
const en_failed_to_restore =
  /** @type {(inputs: Failed_To_RestoreInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Failed to restore`)
  }

const zh_failed_to_restore =
  /** @type {(inputs: Failed_To_RestoreInputs) => LocalizedString} */ () => {
...
export const failed_to_restore =
  /** @type {((inputs?: Failed_To_RestoreInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Failed_To_RestoreInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
