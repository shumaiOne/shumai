...
const en_field_created_successfully =
  /** @type {(inputs: Field_Created_SuccessfullyInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Field created successfully`)
  }

const zh_field_created_successfully =
  /** @type {(inputs: Field_Created_SuccessfullyInputs) => LocalizedString} */ () => {
...
export const field_created_successfully =
  /** @type {((inputs?: Field_Created_SuccessfullyInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Field_Created_SuccessfullyInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
