...
const en_field_updated_successfully =
  /** @type {(inputs: Field_Updated_SuccessfullyInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Field updated successfully`)
  }

const zh_field_updated_successfully =
  /** @type {(inputs: Field_Updated_SuccessfullyInputs) => LocalizedString} */ () => {
...
export const field_updated_successfully =
  /** @type {((inputs?: Field_Updated_SuccessfullyInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Field_Updated_SuccessfullyInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
