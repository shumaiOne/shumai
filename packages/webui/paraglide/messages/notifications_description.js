...
const en_notifications_description =
  /** @type {(inputs: Notifications_DescriptionInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (
      `Configure your personal notification preferences for this team.`
    )
  }

const zh_notifications_description =
  /** @type {(inputs: Notifications_DescriptionInputs) => LocalizedString} */ () => {
...
export const notifications_description =
  /** @type {((inputs?: Notifications_DescriptionInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Notifications_DescriptionInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
