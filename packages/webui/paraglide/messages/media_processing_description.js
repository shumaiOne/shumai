...
const en_media_processing_description =
  /** @type {(inputs: Media_Processing_DescriptionInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Manage your team's media transcoding configurations.`)
  }

const zh_media_processing_description =
  /** @type {(inputs: Media_Processing_DescriptionInputs) => LocalizedString} */ () => {
 ...
 */
export const media_processing_description =
  /** @type {((inputs?: Media_Processing_DescriptionInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Media_Processing_DescriptionInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
