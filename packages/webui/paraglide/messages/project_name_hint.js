...
const en_project_name_hint =
  /** @type {(inputs: Project_Name_HintInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`A clear, concise name to identify your project space.`)
  }

const zh_project_name_hint =
  /** @type {(inputs: Project_Name_HintInputs) => LocalizedString} */ () => {
...
export const project_name_hint =
  /** @type {((inputs?: Project_Name_HintInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Project_Name_HintInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
