...
const en_no_custom_domains_allowed =
  /** @type {(inputs: No_Custom_Domains_AllowedInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`No custom domains allowed`)
  }

const zh_no_custom_domains_allowed =
  /** @type {(inputs: No_Custom_Domains_AllowedInputs) => LocalizedString} */ () => {
...
export const no_custom_domains_allowed =
  /** @type {((inputs?: No_Custom_Domains_AllowedInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<No_Custom_Domains_AllowedInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
