...
const en_untitled_collection =
  /** @type {(inputs: Untitled_CollectionInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Untitled Collection`)
  }

const zh_untitled_collection =
  /** @type {(inputs: Untitled_CollectionInputs) => LocalizedString} */ () => {
...
export const untitled_collection =
  /** @type {((inputs?: Untitled_CollectionInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Untitled_CollectionInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
