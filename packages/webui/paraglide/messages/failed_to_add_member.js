...
const en_failed_to_add_member =
  /** @type {(inputs: Failed_To_Add_MemberInputs) => LocalizedString} */ (i) => {
    return /** @type {LocalizedString} */ (`Failed to add ${i?.name}`)
  }

const zh_failed_to_add_member =
  /** @type {(inputs: Failed_To_Add_MemberInputs) => LocalizedString} */ (i) => {
...
export const failed_to_add_member =
  /** @type {((inputs: Failed_To_Add_MemberInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Failed_To_Add_MemberInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs, options = {}) => {
