...
const en_optional_default_value_placeholder =
  /** @type {(inputs: Optional_Default_Value_PlaceholderInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Optional default value...`)
  }

const zh_optional_default_value_placeholder =
  /** @type {(inputs: Optional_Default_Value_PlaceholderInputs) => LocalizedString} */ () => {
...
export const optional_default_value_placeholder =
  /** @type {((inputs?: Optional_Default_Value_PlaceholderInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Optional_Default_Value_PlaceholderInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
