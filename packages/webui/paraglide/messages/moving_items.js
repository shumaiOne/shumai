...
*/
export const moving_items = /** @type {((inputs: Moving_ItemsInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Moving_ItemsInputs, { locale?: "en" | "zh" }, {}>} */ ((inputs, options = {}) => {
