...
*/
export const comments_notification_description: ((inputs?: Comments_Notification_DescriptionInputs, options?: {
    locale?: "en" | "zh";
}) => LocalizedString) & import("../runtime.js").MessageMetadata<Comments_Notification_DescriptionInputs, {
    locale?: "en" | "zh";
}, {}>;
