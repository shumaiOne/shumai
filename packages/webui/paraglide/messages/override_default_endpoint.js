...
const en_override_default_endpoint =
  /** @type {(inputs: Override_Default_EndpointInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Override the default endpoint.`)
  }

const zh_override_default_endpoint =
  /** @type {(inputs: Override_Default_EndpointInputs) => LocalizedString} */ () => {
...
export const override_default_endpoint =
  /** @type {((inputs?: Override_Default_EndpointInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Override_Default_EndpointInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
