...
*/
export const starting_download_of_n_files: ((inputs: Starting_Download_Of_N_FilesInputs, options?: {
    locale?: "en" | "zh";
}) => LocalizedString) & import("../runtime.js").MessageMetadata<Starting_Download_Of_N_FilesInputs, {
    locale?: "en" | "zh";
}, {}>;
