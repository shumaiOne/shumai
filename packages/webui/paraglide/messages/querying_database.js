...
const en_querying_database =
  /** @type {(inputs: Querying_DatabaseInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Querying database...`)
  }

const zh_querying_database =
  /** @type {(inputs: Querying_DatabaseInputs) => LocalizedString} */ () => {
...
export const querying_database =
  /** @type {((inputs?: Querying_DatabaseInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Querying_DatabaseInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
