...
*/
export const matched_items = /** @type {((inputs: Matched_ItemsInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Matched_ItemsInputs, { locale?: "en" | "zh" }, {}>} */ ((inputs, options = {}) => {
