...
*/
export const theme = /** @type {((inputs?: ThemeInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<ThemeInputs, { locale?: "en" | "zh" }, {}>} */ ((inputs = {}, options = {}) => {
