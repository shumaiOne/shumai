 ...
 */
export const renamed_to =
  /** @type {((inputs?: Renamed_ToInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Renamed_ToInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
