...
const en_show_left_sidebar =
  /** @type {(inputs: Show_Left_SidebarInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Show Left Sidebar`)
  }

const zh_show_left_sidebar =
  /** @type {(inputs: Show_Left_SidebarInputs) => LocalizedString} */ () => {
...
export const show_left_sidebar =
  /** @type {((inputs?: Show_Left_SidebarInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Show_Left_SidebarInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
