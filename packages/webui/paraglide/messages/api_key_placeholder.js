...
const en_api_key_placeholder =
  /** @type {(inputs: Api_Key_PlaceholderInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Enter API Key or Environment Variable`)
  }

const zh_api_key_placeholder =
  /** @type {(inputs: Api_Key_PlaceholderInputs) => LocalizedString} */ () => {
...
export const api_key_placeholder =
  /** @type {((inputs?: Api_Key_PlaceholderInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Api_Key_PlaceholderInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
