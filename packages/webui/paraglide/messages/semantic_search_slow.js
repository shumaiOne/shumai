...
const en_semantic_search_slow =
  /** @type {(inputs: Semantic_Search_SlowInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (
      `Semantic search using media intelligence might be slow...`
    )
  }

const zh_semantic_search_slow =
  /** @type {(inputs: Semantic_Search_SlowInputs) => LocalizedString} */ () => {
...
export const semantic_search_slow =
  /** @type {((inputs?: Semantic_Search_SlowInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Semantic_Search_SlowInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
