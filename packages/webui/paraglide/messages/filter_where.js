...
*/
export const filter_where = /** @type {((inputs?: Filter_WhereInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Filter_WhereInputs, { locale?: "en" | "zh" }, {}>} */ ((inputs = {}, options = {}) => {
