 ...
 */
export const loading_more =
  /** @type {((inputs?: Loading_MoreInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Loading_MoreInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
