...
*/
export const light = /** @type {((inputs?: LightInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<LightInputs, { locale?: "en" | "zh" }, {}>} */ ((inputs = {}, options = {}) => {
