...
const en_notification_mentioned_you =
  /** @type {(inputs: Notification_Mentioned_YouInputs) => LocalizedString} */ (i) => {
    return /** @type {LocalizedString} */ (`${i?.creator} mentioned you in ${i?.asset}`)
  }

const zh_notification_mentioned_you =
  /** @type {(inputs: Notification_Mentioned_YouInputs) => LocalizedString} */ (i) => {
...
export const notification_mentioned_you =
  /** @type {((inputs: Notification_Mentioned_YouInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Notification_Mentioned_YouInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs, options = {}) => {
