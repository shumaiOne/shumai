...
*/
export const operator_is = /** @type {((inputs?: Operator_IsInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Operator_IsInputs, { locale?: "en" | "zh" }, {}>} */ ((inputs = {}, options = {}) => {
