...
const en_successfully_copied_items =
  /** @type {(inputs: Successfully_Copied_ItemsInputs) => LocalizedString} */ (i) => {
    return /** @type {LocalizedString} */ (`Successfully copied ${i?.count} item(s)`)
  }

const zh_successfully_copied_items =
  /** @type {(inputs: Successfully_Copied_ItemsInputs) => LocalizedString} */ (i) => {
...
export const successfully_copied_items =
  /** @type {((inputs: Successfully_Copied_ItemsInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Successfully_Copied_ItemsInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs, options = {}) => {
