...
*/
export const notification_mentioned_you: ((inputs: Notification_Mentioned_YouInputs, options?: {
    locale?: "en" | "zh";
}) => LocalizedString) & import("../runtime.js").MessageMetadata<Notification_Mentioned_YouInputs, {
    locale?: "en" | "zh";
}, {}>;
