...
const en_sort_newest_to_oldest =
  /** @type {(inputs: Sort_Newest_To_OldestInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Newest → Oldest`)
  }

const zh_sort_newest_to_oldest =
  /** @type {(inputs: Sort_Newest_To_OldestInputs) => LocalizedString} */ () => {
...
export const sort_newest_to_oldest =
  /** @type {((inputs?: Sort_Newest_To_OldestInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Sort_Newest_To_OldestInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
