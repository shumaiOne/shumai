...
const en_copied_successfully =
  /** @type {(inputs: Copied_SuccessfullyInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Copied successfully`)
  }

const zh_copied_successfully =
  /** @type {(inputs: Copied_SuccessfullyInputs) => LocalizedString} */ () => {
...
export const copied_successfully =
  /** @type {((inputs?: Copied_SuccessfullyInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Copied_SuccessfullyInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
