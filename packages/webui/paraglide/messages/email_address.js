...
*/
export const email_address = /** @type {((inputs?: Email_AddressInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Email_AddressInputs, { locale?: "en" | "zh" }, {}>} */ ((inputs = {}, options = {}) => {
