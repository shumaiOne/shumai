...
*/
export const enable_embedding_agent_hint: ((inputs?: Enable_Embedding_Agent_HintInputs, options?: {
    locale?: "en" | "zh";
}) => LocalizedString) & import("../runtime.js").MessageMetadata<Enable_Embedding_Agent_HintInputs, {
    locale?: "en" | "zh";
}, {}>;
