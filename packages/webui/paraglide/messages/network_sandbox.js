 ...
 */
export const network_sandbox =
  /** @type {((inputs?: Network_SandboxInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Network_SandboxInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
