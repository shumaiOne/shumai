...
const en_select_a_project =
  /** @type {(inputs: Select_A_ProjectInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Select a project`)
  }

const zh_select_a_project =
  /** @type {(inputs: Select_A_ProjectInputs) => LocalizedString} */ () => {
...
export const select_a_project =
  /** @type {((inputs?: Select_A_ProjectInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Select_A_ProjectInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
