...
const en_confirm_download =
  /** @type {(inputs: Confirm_DownloadInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Confirm Download`)
  }

const zh_confirm_download =
  /** @type {(inputs: Confirm_DownloadInputs) => LocalizedString} */ () => {
...
export const confirm_download =
  /** @type {((inputs?: Confirm_DownloadInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Confirm_DownloadInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
