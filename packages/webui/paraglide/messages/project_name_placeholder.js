...
const en_project_name_placeholder =
  /** @type {(inputs: Project_Name_PlaceholderInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`e.g. Acme Marketing, Q3 Product Launch...`)
  }

const zh_project_name_placeholder =
  /** @type {(inputs: Project_Name_PlaceholderInputs) => LocalizedString} */ () => {
 ...
 */
export const project_name_placeholder =
  /** @type {((inputs?: Project_Name_PlaceholderInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Project_Name_PlaceholderInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
