...
*/
export const line = /** @type {((inputs?: LineInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<LineInputs, { locale?: "en" | "zh" }, {}>} */ ((inputs = {}, options = {}) => {
