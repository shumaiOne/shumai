...
const en_try_adjusting_spelling =
  /** @type {(inputs: Try_Adjusting_SpellingInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Try adjusting spelling or removing filter rows.`)
  }

const zh_try_adjusting_spelling =
  /** @type {(inputs: Try_Adjusting_SpellingInputs) => LocalizedString} */ () => {
 ...
 */
export const try_adjusting_spelling =
  /** @type {((inputs?: Try_Adjusting_SpellingInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Try_Adjusting_SpellingInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
