...
*/
export const notification_status_updated: ((inputs: Notification_Status_UpdatedInputs, options?: {
    locale?: "en" | "zh";
}) => LocalizedString) & import("../runtime.js").MessageMetadata<Notification_Status_UpdatedInputs, {
    locale?: "en" | "zh";
}, {}>;
