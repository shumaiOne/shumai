 ...
 */
export const remove_cover =
  /** @type {((inputs?: Remove_CoverInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Remove_CoverInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
