...
const en_project_notification_updated =
  /** @type {(inputs: Project_Notification_UpdatedInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Project notification settings updated`)
  }

const zh_project_notification_updated =
  /** @type {(inputs: Project_Notification_UpdatedInputs) => LocalizedString} */ () => {
...
export const project_notification_updated =
  /** @type {((inputs?: Project_Notification_UpdatedInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Project_Notification_UpdatedInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
