...
const en_failed_to_remove_member =
  /** @type {(inputs: Failed_To_Remove_MemberInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Failed to remove member`)
  }

const zh_failed_to_remove_member =
  /** @type {(inputs: Failed_To_Remove_MemberInputs) => LocalizedString} */ () => {
...
export const failed_to_remove_member =
  /** @type {((inputs?: Failed_To_Remove_MemberInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Failed_To_Remove_MemberInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
