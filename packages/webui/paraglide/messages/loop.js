...
*/
export const loop = /** @type {((inputs?: LoopInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<LoopInputs, { locale?: "en" | "zh" }, {}>} */ ((inputs = {}, options = {}) => {
