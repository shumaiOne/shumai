 ...
 */
export const n_models_count =
  /** @type {((inputs: N_Models_CountInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<N_Models_CountInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs, options = {}) => {
