...
const en_agent_deleted_successfully =
  /** @type {(inputs: Agent_Deleted_SuccessfullyInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Agent deleted successfully`)
  }

const zh_agent_deleted_successfully =
  /** @type {(inputs: Agent_Deleted_SuccessfullyInputs) => LocalizedString} */ () => {
...
export const agent_deleted_successfully =
  /** @type {((inputs?: Agent_Deleted_SuccessfullyInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Agent_Deleted_SuccessfullyInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
