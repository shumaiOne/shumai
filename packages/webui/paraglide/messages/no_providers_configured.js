...
const en_no_providers_configured =
  /** @type {(inputs: No_Providers_ConfiguredInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`No Providers Configured`)
  }

const zh_no_providers_configured =
  /** @type {(inputs: No_Providers_ConfiguredInputs) => LocalizedString} */ () => {
...
export const no_providers_configured =
  /** @type {((inputs?: No_Providers_ConfiguredInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<No_Providers_ConfiguredInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
