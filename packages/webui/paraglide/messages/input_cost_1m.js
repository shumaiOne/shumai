 ...
 */
export const input_cost_1m =
  /** @type {((inputs?: Input_Cost_1mInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Input_Cost_1mInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
