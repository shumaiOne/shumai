...
*/
export const notification = /** @type {((inputs?: NotificationInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<NotificationInputs, { locale?: "en" | "zh" }, {}>} */ ((inputs = {}, options = {}) => {
