...
const en_api_token_generated_successfully =
  /** @type {(inputs: Api_Token_Generated_SuccessfullyInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`API token generated successfully`)
  }

const zh_api_token_generated_successfully =
  /** @type {(inputs: Api_Token_Generated_SuccessfullyInputs) => LocalizedString} */ () => {
...
export const api_token_generated_successfully =
  /** @type {((inputs?: Api_Token_Generated_SuccessfullyInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Api_Token_Generated_SuccessfullyInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
