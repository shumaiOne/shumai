...
*/
export const agent_soul = /** @type {((inputs?: Agent_SoulInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Agent_SoulInputs, { locale?: "en" | "zh" }, {}>} */ ((inputs = {}, options = {}) => {
