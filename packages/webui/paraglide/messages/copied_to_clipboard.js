...
const en_copied_to_clipboard =
  /** @type {(inputs: Copied_To_ClipboardInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Copied to clipboard`)
  }

const zh_copied_to_clipboard =
  /** @type {(inputs: Copied_To_ClipboardInputs) => LocalizedString} */ () => {
...
export const copied_to_clipboard =
  /** @type {((inputs?: Copied_To_ClipboardInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Copied_To_ClipboardInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
