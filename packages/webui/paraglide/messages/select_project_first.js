...
const en_select_project_first =
  /** @type {(inputs: Select_Project_FirstInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Select a project first`)
  }

const zh_select_project_first =
  /** @type {(inputs: Select_Project_FirstInputs) => LocalizedString} */ () => {
...
export const select_project_first =
  /** @type {((inputs?: Select_Project_FirstInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Select_Project_FirstInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
