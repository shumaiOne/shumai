...
*/
export const descending = /** @type {((inputs?: DescendingInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<DescendingInputs, { locale?: "en" | "zh" }, {}>} */ ((inputs = {}, options = {}) => {
