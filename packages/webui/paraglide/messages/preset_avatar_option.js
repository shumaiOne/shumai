...
const en_preset_avatar_option =
  /** @type {(inputs: Preset_Avatar_OptionInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Preset Avatar Option`)
  }

const zh_preset_avatar_option =
  /** @type {(inputs: Preset_Avatar_OptionInputs) => LocalizedString} */ () => {
...
export const preset_avatar_option =
  /** @type {((inputs?: Preset_Avatar_OptionInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Preset_Avatar_OptionInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
