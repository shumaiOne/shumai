...
*/
export const add_condition = /** @type {((inputs?: Add_ConditionInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Add_ConditionInputs, { locale?: "en" | "zh" }, {}>} */ ((inputs = {}, options = {}) => {
