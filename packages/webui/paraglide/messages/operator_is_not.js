...
*/
export const operator_is_not = /** @type {((inputs?: Operator_Is_NotInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Operator_Is_NotInputs, { locale?: "en" | "zh" }, {}>} */ ((inputs = {}, options = {}) => {
