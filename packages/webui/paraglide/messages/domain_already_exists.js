...
const en_domain_already_exists =
  /** @type {(inputs: Domain_Already_ExistsInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Domain already exists`)
  }

const zh_domain_already_exists =
  /** @type {(inputs: Domain_Already_ExistsInputs) => LocalizedString} */ () => {
...
export const domain_already_exists =
  /** @type {((inputs?: Domain_Already_ExistsInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Domain_Already_ExistsInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
