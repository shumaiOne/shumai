 ...
 */
export const apply_and_close =
  /** @type {((inputs?: Apply_And_CloseInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Apply_And_CloseInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
