...
const en_no_pending_domains =
  /** @type {(inputs: No_Pending_DomainsInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`No pending domains requiring approval`)
  }

const zh_no_pending_domains =
  /** @type {(inputs: No_Pending_DomainsInputs) => LocalizedString} */ () => {
 ...
 */
export const no_pending_domains =
  /** @type {((inputs?: No_Pending_DomainsInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<No_Pending_DomainsInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
