...
const en_agent_session_logs =
  /** @type {(inputs: Agent_Session_LogsInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Agent Session Logs`)
  }

const zh_agent_session_logs =
  /** @type {(inputs: Agent_Session_LogsInputs) => LocalizedString} */ () => {
...
export const agent_session_logs =
  /** @type {((inputs?: Agent_Session_LogsInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Agent_Session_LogsInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
