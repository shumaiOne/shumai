...
const en_disable_timestamp =
  /** @type {(inputs: Disable_TimestampInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Disable Timestamp`)
  }

const zh_disable_timestamp =
  /** @type {(inputs: Disable_TimestampInputs) => LocalizedString} */ () => {
...
export const disable_timestamp =
  /** @type {((inputs?: Disable_TimestampInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Disable_TimestampInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
