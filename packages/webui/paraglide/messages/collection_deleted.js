...
const en_collection_deleted = /** @type {(inputs: Collection_DeletedInputs) => LocalizedString} */ () => {
...
*/
export const collection_deleted = /** @type {((inputs?: Collection_DeletedInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Collection_DeletedInputs, { locale?: "en" | "zh" }, {}>} */ ((inputs = {}, options = {}) => {
