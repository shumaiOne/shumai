 ...
 */
export const date_yesterday =
  /** @type {((inputs?: Date_YesterdayInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Date_YesterdayInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
