...
const en_thinking_strength =
  /** @type {(inputs: Thinking_StrengthInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Thinking Strength`)
  }

const zh_thinking_strength =
  /** @type {(inputs: Thinking_StrengthInputs) => LocalizedString} */ () => {
...
export const thinking_strength =
  /** @type {((inputs?: Thinking_StrengthInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Thinking_StrengthInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
