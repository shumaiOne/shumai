...
const en_successfully_moved_items =
  /** @type {(inputs: Successfully_Moved_ItemsInputs) => LocalizedString} */ (i) => {
    return /** @type {LocalizedString} */ (`Successfully moved ${i?.count} item(s)`)
  }

const zh_successfully_moved_items =
  /** @type {(inputs: Successfully_Moved_ItemsInputs) => LocalizedString} */ (i) => {
...
export const successfully_moved_items =
  /** @type {((inputs: Successfully_Moved_ItemsInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Successfully_Moved_ItemsInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs, options = {}) => {
