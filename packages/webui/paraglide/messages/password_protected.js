...
const en_password_protected =
  /** @type {(inputs: Password_ProtectedInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Password Protected`)
  }

const zh_password_protected =
  /** @type {(inputs: Password_ProtectedInputs) => LocalizedString} */ () => {
...
export const password_protected =
  /** @type {((inputs?: Password_ProtectedInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Password_ProtectedInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
