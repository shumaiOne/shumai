...
const en_collection_saved = /** @type {(inputs: Collection_SavedInputs) => LocalizedString} */ () => {
...
*/
export const collection_saved = /** @type {((inputs?: Collection_SavedInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Collection_SavedInputs, { locale?: "en" | "zh" }, {}>} */ ((inputs = {}, options = {}) => {
