...
const en_failed_to_prepare_download_links =
  /** @type {(inputs: Failed_To_Prepare_Download_LinksInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Failed to prepare download links`)
  }

const zh_failed_to_prepare_download_links =
  /** @type {(inputs: Failed_To_Prepare_Download_LinksInputs) => LocalizedString} */ () => {
...
export const failed_to_prepare_download_links =
  /** @type {((inputs?: Failed_To_Prepare_Download_LinksInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Failed_To_Prepare_Download_LinksInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
