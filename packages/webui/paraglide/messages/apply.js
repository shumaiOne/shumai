...
*/
export const apply = /** @type {((inputs?: ApplyInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<ApplyInputs, { locale?: "en" | "zh" }, {}>} */ ((inputs = {}, options = {}) => {
