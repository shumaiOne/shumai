...
const en_developer_settings =
  /** @type {(inputs: Developer_SettingsInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Developer Settings`)
  }

const zh_developer_settings =
  /** @type {(inputs: Developer_SettingsInputs) => LocalizedString} */ () => {
...
export const developer_settings =
  /** @type {((inputs?: Developer_SettingsInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Developer_SettingsInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
