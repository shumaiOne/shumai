 ...
 */
export const deep_reasoning =
  /** @type {((inputs?: Deep_ReasoningInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Deep_ReasoningInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
