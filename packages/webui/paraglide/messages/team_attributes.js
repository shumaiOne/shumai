...
*/
export const team_attributes = /** @type {((inputs?: Team_AttributesInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Team_AttributesInputs, { locale?: "en" | "zh" }, {}>} */ ((inputs = {}, options = {}) => {
