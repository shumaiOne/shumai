...
const en_provider_name_placeholder =
  /** @type {(inputs: Provider_Name_PlaceholderInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`e.g., My OpenAI`)
  }

const zh_provider_name_placeholder =
  /** @type {(inputs: Provider_Name_PlaceholderInputs) => LocalizedString} */ () => {
...
export const provider_name_placeholder =
  /** @type {((inputs?: Provider_Name_PlaceholderInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Provider_Name_PlaceholderInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
