...
const en_uploading_status =
  /** @type {(inputs: Uploading_StatusInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Uploading`)
  }

const zh_uploading_status =
  /** @type {(inputs: Uploading_StatusInputs) => LocalizedString} */ () => {
...
export const uploading_status =
  /** @type {((inputs?: Uploading_StatusInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Uploading_StatusInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
