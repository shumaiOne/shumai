...
*/
export const remove_member_confirmation: ((inputs: Remove_Member_ConfirmationInputs, options?: {
    locale?: "en" | "zh";
}) => LocalizedString) & import("../runtime.js").MessageMetadata<Remove_Member_ConfirmationInputs, {
    locale?: "en" | "zh";
}, {}>;
