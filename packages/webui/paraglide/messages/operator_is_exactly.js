...
const en_operator_is_exactly =
  /** @type {(inputs: Operator_Is_ExactlyInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`is exactly`)
  }

const zh_operator_is_exactly =
  /** @type {(inputs: Operator_Is_ExactlyInputs) => LocalizedString} */ () => {
...
export const operator_is_exactly =
  /** @type {((inputs?: Operator_Is_ExactlyInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Operator_Is_ExactlyInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
