...
const en_moved_successfully =
  /** @type {(inputs: Moved_SuccessfullyInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Moved successfully`)
  }

const zh_moved_successfully =
  /** @type {(inputs: Moved_SuccessfullyInputs) => LocalizedString} */ () => {
...
export const moved_successfully =
  /** @type {((inputs?: Moved_SuccessfullyInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Moved_SuccessfullyInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
