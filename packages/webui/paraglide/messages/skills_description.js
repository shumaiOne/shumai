...
const en_skills_description =
  /** @type {(inputs: Skills_DescriptionInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Add, update and configure AI skills for the team.`)
  }

const zh_skills_description =
  /** @type {(inputs: Skills_DescriptionInputs) => LocalizedString} */ () => {
...
export const skills_description =
  /** @type {((inputs?: Skills_DescriptionInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Skills_DescriptionInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
