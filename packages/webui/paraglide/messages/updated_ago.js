...
*/
export const updated_ago = /** @type {((inputs?: Updated_AgoInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Updated_AgoInputs, { locale?: "en" | "zh" }, {}>} */ ((inputs = {}, options = {}) => {
