...
const en_skills_management_description =
  /** @type {(inputs: Skills_Management_DescriptionInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Extend your chatbot's capabilities with custom skills.`)
  }

const zh_skills_management_description =
  /** @type {(inputs: Skills_Management_DescriptionInputs) => LocalizedString} */ () => {
 ...
 */
export const skills_management_description =
  /** @type {((inputs?: Skills_Management_DescriptionInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Skills_Management_DescriptionInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
