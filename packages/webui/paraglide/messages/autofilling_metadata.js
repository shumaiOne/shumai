...
const en_autofilling_metadata =
  /** @type {(inputs: Autofilling_MetadataInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Autofilling metadata...`)
  }

const zh_autofilling_metadata =
  /** @type {(inputs: Autofilling_MetadataInputs) => LocalizedString} */ () => {
...
export const autofilling_metadata =
  /** @type {((inputs?: Autofilling_MetadataInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Autofilling_MetadataInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
