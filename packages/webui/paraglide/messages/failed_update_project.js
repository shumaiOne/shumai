...
const en_failed_update_project =
  /** @type {(inputs: Failed_Update_ProjectInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Failed to update project`)
  }

const zh_failed_update_project =
  /** @type {(inputs: Failed_Update_ProjectInputs) => LocalizedString} */ () => {
...
export const failed_update_project =
  /** @type {((inputs?: Failed_Update_ProjectInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Failed_Update_ProjectInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
