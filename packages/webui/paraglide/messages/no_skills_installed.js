...
const en_no_skills_installed =
  /** @type {(inputs: No_Skills_InstalledInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`No skills installed`)
  }

const zh_no_skills_installed =
  /** @type {(inputs: No_Skills_InstalledInputs) => LocalizedString} */ () => {
...
export const no_skills_installed =
  /** @type {((inputs?: No_Skills_InstalledInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<No_Skills_InstalledInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
