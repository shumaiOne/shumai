...
const en_enter_your_details =
  /** @type {(inputs: Enter_Your_DetailsInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Enter your details`)
  }

const zh_enter_your_details =
  /** @type {(inputs: Enter_Your_DetailsInputs) => LocalizedString} */ () => {
...
export const enter_your_details =
  /** @type {((inputs?: Enter_Your_DetailsInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Enter_Your_DetailsInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
