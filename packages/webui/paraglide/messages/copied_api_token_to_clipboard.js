...
const en_copied_api_token_to_clipboard =
  /** @type {(inputs: Copied_Api_Token_To_ClipboardInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Copied API token to clipboard`)
  }

const zh_copied_api_token_to_clipboard =
  /** @type {(inputs: Copied_Api_Token_To_ClipboardInputs) => LocalizedString} */ () => {
...
export const copied_api_token_to_clipboard =
  /** @type {((inputs?: Copied_Api_Token_To_ClipboardInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Copied_Api_Token_To_ClipboardInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
