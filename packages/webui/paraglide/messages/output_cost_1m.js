 ...
 */
export const output_cost_1m =
  /** @type {((inputs?: Output_Cost_1mInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Output_Cost_1mInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
