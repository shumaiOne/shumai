...
const en_personal_info_description =
  /** @type {(inputs: Personal_Info_DescriptionInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Manage your profile name and avatar image.`)
  }

const zh_personal_info_description =
  /** @type {(inputs: Personal_Info_DescriptionInputs) => LocalizedString} */ () => {
...
export const personal_info_description =
  /** @type {((inputs?: Personal_Info_DescriptionInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Personal_Info_DescriptionInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
