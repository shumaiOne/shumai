...
const en_manage_project_description =
  /** @type {(inputs: Manage_Project_DescriptionInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (
      `Manage and update your project workspace configurations.`
    )
  }

const zh_manage_project_description =
  /** @type {(inputs: Manage_Project_DescriptionInputs) => LocalizedString} */ () => {
...
export const manage_project_description =
  /** @type {((inputs?: Manage_Project_DescriptionInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Manage_Project_DescriptionInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
