...
const en_failed_create_folder =
  /** @type {(inputs: Failed_Create_FolderInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Failed to create folder`)
  }

const zh_failed_create_folder =
  /** @type {(inputs: Failed_Create_FolderInputs) => LocalizedString} */ () => {
...
export const failed_create_folder =
  /** @type {((inputs?: Failed_Create_FolderInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Failed_Create_FolderInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
