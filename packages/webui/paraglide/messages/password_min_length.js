...
const en_password_min_length =
  /** @type {(inputs: Password_Min_LengthInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Password must be at least 3 characters`)
  }

const zh_password_min_length =
  /** @type {(inputs: Password_Min_LengthInputs) => LocalizedString} */ () => {
...
export const password_min_length =
  /** @type {((inputs?: Password_Min_LengthInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Password_Min_LengthInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
