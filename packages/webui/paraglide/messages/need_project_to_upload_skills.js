...
const en_need_project_to_upload_skills =
  /** @type {(inputs: Need_Project_To_Upload_SkillsInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (
      `You need at least one project in your team to upload skills.`
    )
  }

const zh_need_project_to_upload_skills =
  /** @type {(inputs: Need_Project_To_Upload_SkillsInputs) => LocalizedString} */ () => {
...
export const need_project_to_upload_skills =
  /** @type {((inputs?: Need_Project_To_Upload_SkillsInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Need_Project_To_Upload_SkillsInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
