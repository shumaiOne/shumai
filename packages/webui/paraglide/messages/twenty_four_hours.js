...
const en_twenty_four_hours =
  /** @type {(inputs: Twenty_Four_HoursInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`24 Hours`)
  }

const zh_twenty_four_hours =
  /** @type {(inputs: Twenty_Four_HoursInputs) => LocalizedString} */ () => {
...
export const twenty_four_hours =
  /** @type {((inputs?: Twenty_Four_HoursInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Twenty_Four_HoursInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
