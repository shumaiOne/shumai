...
const en_agent_created_successfully =
  /** @type {(inputs: Agent_Created_SuccessfullyInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Agent created successfully`)
  }

const zh_agent_created_successfully =
  /** @type {(inputs: Agent_Created_SuccessfullyInputs) => LocalizedString} */ () => {
...
export const agent_created_successfully =
  /** @type {((inputs?: Agent_Created_SuccessfullyInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Agent_Created_SuccessfullyInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
