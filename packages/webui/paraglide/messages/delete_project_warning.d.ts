...
*/
export const delete_project_warning: ((inputs: Delete_Project_WarningInputs, options?: {
    locale?: "en" | "zh";
}) => LocalizedString) & import("../runtime.js").MessageMetadata<Delete_Project_WarningInputs, {
    locale?: "en" | "zh";
}, {}>;
