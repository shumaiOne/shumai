...
const en_env_var_empty_note =
  /** @type {(inputs: Env_Var_Empty_NoteInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (
      `If left empty, the value will be read from the host machine's environment.`
    )
  }

const zh_env_var_empty_note =
  /** @type {(inputs: Env_Var_Empty_NoteInputs) => LocalizedString} */ () => {
...
export const env_var_empty_note =
  /** @type {((inputs?: Env_Var_Empty_NoteInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Env_Var_Empty_NoteInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
