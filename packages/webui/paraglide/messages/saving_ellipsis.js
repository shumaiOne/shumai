...
*/
export const saving_ellipsis = /** @type {((inputs?: Saving_EllipsisInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Saving_EllipsisInputs, { locale?: "en" | "zh" }, {}>} */ ((inputs = {}, options = {}) => {
