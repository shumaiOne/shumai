...
*/
export const add_variable = /** @type {((inputs?: Add_VariableInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Add_VariableInputs, { locale?: "en" | "zh" }, {}>} */ ((inputs = {}, options = {}) => {
