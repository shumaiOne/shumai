...
const en_contains_drawing_annotations =
  /** @type {(inputs: Contains_Drawing_AnnotationsInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Contains drawing annotations`)
  }

const zh_contains_drawing_annotations =
  /** @type {(inputs: Contains_Drawing_AnnotationsInputs) => LocalizedString} */ () => {
...
export const contains_drawing_annotations =
  /** @type {((inputs?: Contains_Drawing_AnnotationsInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Contains_Drawing_AnnotationsInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
