...
const en_import_skill_description =
  /** @type {(inputs: Import_Skill_DescriptionInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (
      `Import a skill from a local ZIP archive or a GitHub repository.`
    )
  }

const zh_import_skill_description =
  /** @type {(inputs: Import_Skill_DescriptionInputs) => LocalizedString} */ () => {
...
export const import_skill_description =
  /** @type {((inputs?: Import_Skill_DescriptionInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Import_Skill_DescriptionInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
