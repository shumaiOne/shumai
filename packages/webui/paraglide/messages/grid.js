...
*/
export const grid = /** @type {((inputs?: GridInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<GridInputs, { locale?: "en" | "zh" }, {}>} */ ((inputs = {}, options = {}) => {
