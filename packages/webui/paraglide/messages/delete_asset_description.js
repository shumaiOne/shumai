...
const en_delete_asset_description =
  /** @type {(inputs: Delete_Asset_DescriptionInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (
      `Deleted items can be recovered for 30 days before being permanently deleted.`
    )
  }

const zh_delete_asset_description =
  /** @type {(inputs: Delete_Asset_DescriptionInputs) => LocalizedString} */ () => {
...
export const delete_asset_description =
  /** @type {((inputs?: Delete_Asset_DescriptionInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Delete_Asset_DescriptionInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
