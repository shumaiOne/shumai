...
*/
export const essentials = /** @type {((inputs?: EssentialsInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<EssentialsInputs, { locale?: "en" | "zh" }, {}>} */ ((inputs = {}, options = {}) => {
