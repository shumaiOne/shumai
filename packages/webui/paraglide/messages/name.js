...
*/
export const name = /** @type {((inputs?: NameInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<NameInputs, { locale?: "en" | "zh" }, {}>} */ ((inputs = {}, options = {}) => {
