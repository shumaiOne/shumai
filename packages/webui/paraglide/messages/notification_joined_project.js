...
const en_notification_joined_project =
  /** @type {(inputs: Notification_Joined_ProjectInputs) => LocalizedString} */ (i) => {
    return /** @type {LocalizedString} */ (`${i?.user} joined ${i?.project}`)
  }

const zh_notification_joined_project =
  /** @type {(inputs: Notification_Joined_ProjectInputs) => LocalizedString} */ (i) => {
...
export const notification_joined_project =
  /** @type {((inputs: Notification_Joined_ProjectInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Notification_Joined_ProjectInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs, options = {}) => {
