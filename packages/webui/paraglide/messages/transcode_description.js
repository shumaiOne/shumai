...
const en_transcode_description =
  /** @type {(inputs: Transcode_DescriptionInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Manage your team's media transcoding configurations.`)
  }

const zh_transcode_description =
  /** @type {(inputs: Transcode_DescriptionInputs) => LocalizedString} */ () => {
 ...
 */
export const transcode_description =
  /** @type {((inputs?: Transcode_DescriptionInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Transcode_DescriptionInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
