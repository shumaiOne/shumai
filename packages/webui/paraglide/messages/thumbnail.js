...
*/
export const thumbnail = /** @type {((inputs?: ThumbnailInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<ThumbnailInputs, { locale?: "en" | "zh" }, {}>} */ ((inputs = {}, options = {}) => {
