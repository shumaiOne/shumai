...
*/
export const general = /** @type {((inputs?: GeneralInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<GeneralInputs, { locale?: "en" | "zh" }, {}>} */ ((inputs = {}, options = {}) => {
