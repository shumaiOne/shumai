...
const en_auth_community_cta =
  /** @type {(inputs: Auth_Community_CtaInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Join our community of developers and designers.`)
  }

const zh_auth_community_cta =
  /** @type {(inputs: Auth_Community_CtaInputs) => LocalizedString} */ () => {
...
export const auth_community_cta =
  /** @type {((inputs?: Auth_Community_CtaInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Auth_Community_CtaInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
