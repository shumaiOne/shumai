...
const en_token_name_placeholder =
  /** @type {(inputs: Token_Name_PlaceholderInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`e.g. My CLI token`)
  }

const zh_token_name_placeholder =
  /** @type {(inputs: Token_Name_PlaceholderInputs) => LocalizedString} */ () => {
...
export const token_name_placeholder =
  /** @type {((inputs?: Token_Name_PlaceholderInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Token_Name_PlaceholderInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
