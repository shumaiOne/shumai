...
const en_field_updated_at =
  /** @type {(inputs: Field_Updated_AtInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Updated At`)
  }

const zh_field_updated_at =
  /** @type {(inputs: Field_Updated_AtInputs) => LocalizedString} */ () => {
...
export const field_updated_at =
  /** @type {((inputs?: Field_Updated_AtInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Field_Updated_AtInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
