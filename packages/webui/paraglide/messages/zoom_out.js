...
*/
export const zoom_out = /** @type {((inputs?: Zoom_OutInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Zoom_OutInputs, { locale?: "en" | "zh" }, {}>} */ ((inputs = {}, options = {}) => {
