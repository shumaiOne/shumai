...
const en_field_created_at =
  /** @type {(inputs: Field_Created_AtInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Created At`)
  }

const zh_field_created_at =
  /** @type {(inputs: Field_Created_AtInputs) => LocalizedString} */ () => {
...
export const field_created_at =
  /** @type {((inputs?: Field_Created_AtInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Field_Created_AtInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
