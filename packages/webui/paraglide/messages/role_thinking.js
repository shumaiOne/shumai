...
*/
export const role_thinking = /** @type {((inputs?: Role_ThinkingInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Role_ThinkingInputs, { locale?: "en" | "zh" }, {}>} */ ((inputs = {}, options = {}) => {
