...
const en_failed_to_upload_file =
  /** @type {(inputs: Failed_To_Upload_FileInputs) => LocalizedString} */ (i) => {
    return /** @type {LocalizedString} */ (`Failed to upload file: ${i?.name}`)
  }

const zh_failed_to_upload_file =
  /** @type {(inputs: Failed_To_Upload_FileInputs) => LocalizedString} */ (i) => {
...
export const failed_to_upload_file =
  /** @type {((inputs: Failed_To_Upload_FileInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Failed_To_Upload_FileInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs, options = {}) => {
