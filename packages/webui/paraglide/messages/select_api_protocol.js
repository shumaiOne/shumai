...
const en_select_api_protocol =
  /** @type {(inputs: Select_Api_ProtocolInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Select API Protocol`)
  }

const zh_select_api_protocol =
  /** @type {(inputs: Select_Api_ProtocolInputs) => LocalizedString} */ () => {
...
export const select_api_protocol =
  /** @type {((inputs?: Select_Api_ProtocolInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Select_Api_ProtocolInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
