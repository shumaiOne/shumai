...
*/
export const allowed_domains = /** @type {((inputs?: Allowed_DomainsInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Allowed_DomainsInputs, { locale?: "en" | "zh" }, {}>} */ ((inputs = {}, options = {}) => {
