...
*/
export const folder_renamed = /** @type {((inputs?: Folder_RenamedInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Folder_RenamedInputs, { locale?: "en" | "zh" }, {}>} */ ((inputs = {}, options = {}) => {
