...
const en_configure_skill = /** @type {(inputs: Configure_SkillInputs) => LocalizedString} */ (
  i,
) => {
  return /** @type {LocalizedString} */ (`Configure Skill: ${i?.name}`)
}

const zh_configure_skill = /** @type {(inputs: Configure_SkillInputs) => LocalizedString} */ (
  i,
) => {
...
export const configure_skill =
  /** @type {((inputs: Configure_SkillInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Configure_SkillInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs, options = {}) => {
