...
const en_no_models_configured =
  /** @type {(inputs: No_Models_ConfiguredInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`No models configured`)
  }

const zh_no_models_configured =
  /** @type {(inputs: No_Models_ConfiguredInputs) => LocalizedString} */ () => {
...
export const no_models_configured =
  /** @type {((inputs?: No_Models_ConfiguredInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<No_Models_ConfiguredInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
