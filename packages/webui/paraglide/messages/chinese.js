...
*/
export const chinese = /** @type {((inputs?: ChineseInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<ChineseInputs, { locale?: "en" | "zh" }, {}>} */ ((inputs = {}, options = {}) => {
