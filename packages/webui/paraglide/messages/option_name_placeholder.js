...
const en_option_name_placeholder =
  /** @type {(inputs: Option_Name_PlaceholderInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Option name`)
  }

const zh_option_name_placeholder =
  /** @type {(inputs: Option_Name_PlaceholderInputs) => LocalizedString} */ () => {
...
export const option_name_placeholder =
  /** @type {((inputs?: Option_Name_PlaceholderInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Option_Name_PlaceholderInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
