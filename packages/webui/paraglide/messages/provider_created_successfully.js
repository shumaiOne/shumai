...
const en_provider_created_successfully =
  /** @type {(inputs: Provider_Created_SuccessfullyInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Provider created successfully`)
  }

const zh_provider_created_successfully =
  /** @type {(inputs: Provider_Created_SuccessfullyInputs) => LocalizedString} */ () => {
...
export const provider_created_successfully =
  /** @type {((inputs?: Provider_Created_SuccessfullyInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Provider_Created_SuccessfullyInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
