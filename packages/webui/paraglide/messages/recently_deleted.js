...
const en_recently_deleted =
  /** @type {(inputs: Recently_DeletedInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Recently Deleted`)
  }

const zh_recently_deleted =
  /** @type {(inputs: Recently_DeletedInputs) => LocalizedString} */ () => {
...
export const recently_deleted =
  /** @type {((inputs?: Recently_DeletedInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Recently_DeletedInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
