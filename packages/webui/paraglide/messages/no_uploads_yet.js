 ...
 */
export const no_uploads_yet =
  /** @type {((inputs?: No_Uploads_YetInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<No_Uploads_YetInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
