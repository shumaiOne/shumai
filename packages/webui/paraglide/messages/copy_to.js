...
*/
export const copy_to = /** @type {((inputs?: Copy_ToInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Copy_ToInputs, { locale?: "en" | "zh" }, {}>} */ ((inputs = {}, options = {}) => {
