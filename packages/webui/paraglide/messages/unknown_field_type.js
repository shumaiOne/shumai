...
const en_unknown_field_type =
  /** @type {(inputs: Unknown_Field_TypeInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Unknown Field Type`)
  }

const zh_unknown_field_type =
  /** @type {(inputs: Unknown_Field_TypeInputs) => LocalizedString} */ () => {
...
export const unknown_field_type =
  /** @type {((inputs?: Unknown_Field_TypeInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Unknown_Field_TypeInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
