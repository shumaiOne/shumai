...
const en_manage_env_vars_description =
  /** @type {(inputs: Manage_Env_Vars_DescriptionInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Manage environment variables for this skill instance.`)
  }

const zh_manage_env_vars_description =
  /** @type {(inputs: Manage_Env_Vars_DescriptionInputs) => LocalizedString} */ () => {
...
export const manage_env_vars_description =
  /** @type {((inputs?: Manage_Env_Vars_DescriptionInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Manage_Env_Vars_DescriptionInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
