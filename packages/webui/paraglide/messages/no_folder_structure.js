...
const en_no_folder_structure =
  /** @type {(inputs: No_Folder_StructureInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`No Folder Structure`)
  }

const zh_no_folder_structure =
  /** @type {(inputs: No_Folder_StructureInputs) => LocalizedString} */ () => {
...
export const no_folder_structure =
  /** @type {((inputs?: No_Folder_StructureInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<No_Folder_StructureInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
