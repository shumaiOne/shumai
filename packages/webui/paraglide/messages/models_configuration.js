...
const en_models_configuration =
  /** @type {(inputs: Models_ConfigurationInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Models Configuration`)
  }

const zh_models_configuration =
  /** @type {(inputs: Models_ConfigurationInputs) => LocalizedString} */ () => {
...
export const models_configuration =
  /** @type {((inputs?: Models_ConfigurationInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Models_ConfigurationInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
