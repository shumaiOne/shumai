...
*/
export const delete_agent_confirmation: ((inputs: Delete_Agent_ConfirmationInputs, options?: {
    locale?: "en" | "zh";
}) => LocalizedString) & import("../runtime.js").MessageMetadata<Delete_Agent_ConfirmationInputs, {
    locale?: "en" | "zh";
}, {}>;
