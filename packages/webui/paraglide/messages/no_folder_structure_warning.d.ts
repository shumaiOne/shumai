...
*/
export const no_folder_structure_warning: ((inputs?: No_Folder_Structure_WarningInputs, options?: {
    locale?: "en" | "zh";
}) => LocalizedString) & import("../runtime.js").MessageMetadata<No_Folder_Structure_WarningInputs, {
    locale?: "en" | "zh";
}, {}>;
