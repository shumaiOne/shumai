...
const en_general_comments =
  /** @type {(inputs: General_CommentsInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`General Comments`)
  }

const zh_general_comments =
  /** @type {(inputs: General_CommentsInputs) => LocalizedString} */ () => {
...
export const general_comments =
  /** @type {((inputs?: General_CommentsInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<General_CommentsInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
