...
const en_developer_description =
  /** @type {(inputs: Developer_DescriptionInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (
      `Generate and manage API keys for developers and automated workflows.`
    )
  }

const zh_developer_description =
  /** @type {(inputs: Developer_DescriptionInputs) => LocalizedString} */ () => {
...
export const developer_description =
  /** @type {((inputs?: Developer_DescriptionInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Developer_DescriptionInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
