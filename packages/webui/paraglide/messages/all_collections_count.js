...
const en_all_collections_count =
  /** @type {(inputs: All_Collections_CountInputs) => LocalizedString} */ (i) => {
    return /** @type {LocalizedString} */ (`All Collections (${i?.count})`)
  }

const zh_all_collections_count =
  /** @type {(inputs: All_Collections_CountInputs) => LocalizedString} */ (i) => {
 ...
 */
export const all_collections_count =
  /** @type {((inputs: All_Collections_CountInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<All_Collections_CountInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs, options = {}) => {
