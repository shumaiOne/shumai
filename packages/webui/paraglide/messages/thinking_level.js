...
*/
export const thinking_level = /** @type {((inputs?: Thinking_LevelInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Thinking_LevelInputs, { locale?: "en" | "zh" }, {}>} */ ((inputs = {}, options = {}) => {
