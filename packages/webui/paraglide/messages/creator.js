...
*/
export const creator = /** @type {((inputs?: CreatorInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<CreatorInputs, { locale?: "en" | "zh" }, {}>} */ ((inputs = {}, options = {}) => {
