...
const en_delete_permanently =
  /** @type {(inputs: Delete_PermanentlyInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Delete Permanently`)
  }

const zh_delete_permanently =
  /** @type {(inputs: Delete_PermanentlyInputs) => LocalizedString} */ () => {
...
export const delete_permanently =
  /** @type {((inputs?: Delete_PermanentlyInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Delete_PermanentlyInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
