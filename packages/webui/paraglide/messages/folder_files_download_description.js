...
const en_folder_files_download_description =
  /** @type {(inputs: Folder_Files_Download_DescriptionInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Selected folder files will be prepared for download.`)
  }

const zh_folder_files_download_description =
  /** @type {(inputs: Folder_Files_Download_DescriptionInputs) => LocalizedString} */ () => {
...
export const folder_files_download_description =
  /** @type {((inputs?: Folder_Files_Download_DescriptionInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Folder_Files_Download_DescriptionInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
