...
*/
export const quick_reasoning = /** @type {((inputs?: Quick_ReasoningInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Quick_ReasoningInputs, { locale?: "en" | "zh" }, {}>} */ ((inputs = {}, options = {}) => {
