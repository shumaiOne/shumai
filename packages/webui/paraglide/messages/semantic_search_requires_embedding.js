...
const en_semantic_search_requires_embedding =
  /** @type {(inputs: Semantic_Search_Requires_EmbeddingInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`* Semantic search requires an enabled embedding agent.`)
  }

const zh_semantic_search_requires_embedding =
  /** @type {(inputs: Semantic_Search_Requires_EmbeddingInputs) => LocalizedString} */ () => {
 ...
 */
export const semantic_search_requires_embedding =
  /** @type {((inputs?: Semantic_Search_Requires_EmbeddingInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Semantic_Search_Requires_EmbeddingInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
