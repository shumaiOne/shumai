...
const en_language_settings =
  /** @type {(inputs: Language_SettingsInputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Language Settings`)
  }

const zh_language_settings =
  /** @type {(inputs: Language_SettingsInputs) => LocalizedString} */ () => {
...
export const language_settings =
  /** @type {((inputs?: Language_SettingsInputs, options?: { locale?: "en" | "zh" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Language_SettingsInputs, { locale?: "en" | "zh" }, {}>} */ (
    (inputs = {}, options = {}) => {
