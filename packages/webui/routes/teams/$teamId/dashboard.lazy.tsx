...
import { BarChart2, Loader2, MessageSquareCode, ShieldAlert } from 'lucide-react'

type DashboardTab = 'ai-usage' | 'sessions'
      ...
      <div className="flex flex-col md:flex-row h-full">
        ...
        <div className="flex-1 overflow-y-auto p-4 md:p-8">
          <div className="max-w-6xl mx-auto space-y-8">
            ...
            {activeTab === 'sessions' && <AgentSessionsDashboard teamId={teamId} />}
          </div>
        </div>
      </div>
    </div>
