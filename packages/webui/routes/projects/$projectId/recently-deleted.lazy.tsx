...
import { projectInfoQueryOptions } from './recently-deleted'
...
function RecentlyDeletedPage() {
  ...
  return (
    <FileSystemManager
      ...
      assetId="recently-deleted"
      rootFolderId={rootFolderId}
    />
  )
}

export const Route = createLazyFileRoute('/projects/$projectId/recently-deleted')({
