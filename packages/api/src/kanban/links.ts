...
import { createKanbanLinkSchema, setKanbanDependenciesSchema, AuditAction } from '@shumai/dtos'
...
const route = new Hono<{ Variables: { user: User } }>()
  .put(
    ...
    zValidator('json', setKanbanDependenciesSchema),
    async (c) => {
      ...
      await kanbanService.setDependencies(taskId, req.parentIds, user.id)
