...
## AI Credentials Backup

Optional global keys to pre-authorize the built-in AI providers on startup.

| Variable            | Description                            | Example / Default |
| :------------------ | :------------------------------------- | :---------------- |
| `GEMINI_API_KEY`    | Global key for Google Gemini provider. | `AIzaSy...`       |
| `OPENAI_API_KEY`    | Global key for OpenAI provider.        | `sk-proj-...`     |
| `ANTHROPIC_API_KEY` | Global key for Anthropic provider.     | `sk-ant-...`      |
