...
1. Locate the existing share link under the **Shares** section in the project sidebar.
2. Select the files or folders you want to add from your file browser.
3. Drag and drop them directly onto the share link item in the sidebar.
4. The share link will immediately update to include the newly added assets.
